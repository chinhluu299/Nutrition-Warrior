...
import { View, Text, Image, Button, Touchable, TouchableOpacity, ScrollView } from "react-native";
            ...
            <View style={styles.container}>
               <View style={styles.background_title}>
                ...
                <View style={styles.timestamp}>
                    <ScrollView style={styles.timestamp_scroll} horizontal={true} showsHorizontalScrollIndicator={false}>
                        {
                            options.map((element)=>(
                                <TouchableOpacity key={element.key} onPress={() => setTimestamp(element.key)}
                                    style={[styles.timestamp_element, element.key === timestamp && styles.timestamp_element_active]}>
               ...
               <View style={{flex: 1}}>
                    <KcalPieChart breakfast={100} lunch={200} dinner={150} supper={160} snack={200}/>        
               </View>
            </View>
        );
    }else{
