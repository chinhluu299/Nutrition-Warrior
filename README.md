...
+ Cooking guide
+ Food lookup
+ Add food to daily logs
+ Exercise guide
+ Add workout to daily logs
+ Daily workouts
+ Daily log
+ View statistical charts
+ User tracking
+ Post updates
+ Feedback from AI assistant (Apply Gemini)
+ Meal analysis
...
### Link Services
**Authentication Service:** https://github.com/chinhluu299/NutritionWarriorAuthenService
